      ...
      <Wrapper className="flex justify-center self-end">
        <div className="w-full ">
          <div className='md:flex-row flex-col items-center flex md:justify-between w-full pb-6'>
            <div>
              {/* Logo */}
              <Anchor elementId='footer-logo' href={generateHref(router.query.locale as string, '')} className="xl:flex-1 flex-shrink-0 text-2xl font-extrabold bg-gradient-text bg-clip-text text-transparent font-monrope tracking-tighterText">
              <VoiceStackResources/>
              </Anchor>
            </div>
            {/* Social media   */}
