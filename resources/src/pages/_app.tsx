...
import { cookieSelector, slugToCapitalized } from '~/resources/utils/common'
...
import { createObservedUser, createSession, createUser, getUserData, TrackUserProvider } from '~/resources/utils/tracker/intitialize'
...
function App({
  ...
  // PostHog: page views and URL for initial load + client-side navigations
  useEffect(() => {
    initPosthog()
    capturePageview()
