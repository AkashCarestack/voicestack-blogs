        ...
        <div className="flex flex-col items-center w-full">
          ...
          >
            <div className="flex flex-col w-full max-w-[780px] text-center gap-4">
              <H2>
                {getTextByReferrer(refer, data?.logoSectionHeaderRef || [])}
              </H2>
              <Paragraph
                dangerouslySetInnerHTML={{
                  __html: getTextByReferrer(
                    refer,
                    data?.logoSectionHeaderDescRef || [],
                  ),
                }}
              ></Paragraph>
            </div>
          ...
          <div className="md:block hidden">
            {data?.testimonial?.length > 0 && (
              <div className="xl:h-96 w-full mb-16 justify-center flex flex-wrap gap-3">
