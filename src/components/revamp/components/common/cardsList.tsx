        ...
        <div className="flex md:flex-row flex-col gap-6">
          {data?.items?.map((item: any) => {
            return (
              <div
                key={item._key}
                className="flex bg-[#F4F3FA] xl:min-w-[280px] flex-col items-start md:rounded-[24px] rounded-[12px] text-left md:p-6 p-4"
              >
                <div
                ...
                />
                <h3 className="md:text-lg w-full text-base font-bold leading-[120%] font-manrope text-gray-950">
                  {item.heading}
                </h3>
