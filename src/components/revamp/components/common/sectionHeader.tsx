  ...
  return (
    <div className={`flex ${data.isLeftAlign ? 'justify-start' : 'justify-center'} `}>
         <div className={`w-full ${data.isLeftAlign ? 'text-left' : 'text-center lg:w-[850px]'} ${data.className}`}>
          ...
          <span className={` lg:w-[850px] lg:text-lg text-base font-normal leading-[155.55%] [&_span]:text-vs-blue ${data.isWhite ? 'text-white' : 'text-gray-700'}`} dangerouslySetInnerHTML={{ __html: data.description }}></span>
