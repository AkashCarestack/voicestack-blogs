export default function IconBadge({
  ...
  return (
    ...
    {icon && <span dangerouslySetInnerHTML={{ __html: icon }} className="text-[#1E2939] group-hover:text-white transition-colors duration-300 [&_svg]:fill-[#1E2939] group-hover:[&_svg]:fill-white [&_svg]:transition-colors [&_svg]:duration-300" ></span>}
    </div>
  )
}
