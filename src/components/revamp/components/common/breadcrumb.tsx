        ...
        <Anchor href="/" className="flex items-center justify-center">
          <div className="w-8 h-8 rounded-[4px] bg-[#4A3CE11A]/10 flex items-center justify-center">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M1.875 9.99994L9.33667 2.53744C9.70333 2.1716 10.2967 2.1716 10.6625 2.53744L18.125 9.99994M3.75 8.12494V16.5624C3.75 17.0799 4.17 17.4999 4.6875 17.4999H8.125V13.4374C8.125 12.9199 8.545 12.4999 9.0625 12.4999H10.9375C11.455 12.4999 11.875 12.9199 11.875 13.4374V17.4999H15.3125C15.83 17.4999 16.25 17.0799 16.25 16.5624V8.12494M6.875 17.4999H13.75" stroke="#030712" stroke-width="1.4881" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </div>
        </Anchor>
