...
const ComparisonCardsSection = ({ data, colCount = 4, minimal = false }: ComparisonCardsSectionProps) => {

  const gridCols = colCount === 2 ? 'lg:grid-cols-2' : colCount === 3 ? 'lg:grid-cols-3' : 'lg:grid-cols-4';
  ...
  return (
    ...
    minimal? (
        <Section className="relative bg-[#FFFFFF]"  border="b">
          <Container
            className="w-full justify-center py-sm md:py-md "
            type="V2"
            border="y-0"
          >
