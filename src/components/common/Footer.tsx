...
const Footer = ({ data }) => {
  ...
  const defaultSocialMedia = {
    linkedin: 'https://zynva.in',
    facebook: 'https://zynva.in',
    twitter: 'https://zynva.in',
    discord: 'https://zynva.in',
  }
  ...
  // Merge social media with defaults
  const socialMedia = {
    ...defaultSocialMedia,
    ...(safeData.socialMedia || {}),
  }
              ...
              <div className="flex flex-col md:flex-row gap-6 items-center justify-between">
                ...
                {(data?.socialMedia || socialMedia) && (
                  <div className="flex items-center gap-3">
                    {(socialMedia.linkedin || data?.socialMedia?.linkedin) && (
                      <SocialIcon
                        className=""
                        href={socialMedia.linkedin || data?.socialMedia?.linkedin || 'https://zynva.in'}
                        title="LinkedIn"
                      >
                        <svg
                    ...
                    {(socialMedia.facebook || data?.socialMedia?.facebook) && (
                      <SocialIcon
                        href={socialMedia.facebook || data?.socialMedia?.facebook || 'https://zynva.in'}
                        title="Facebook"
                      >
                        <svg
                          className="group-hover:text-white text-gray-400 transition-colors duration-300"
                    ...
                    {(socialMedia.instagram || data?.socialMedia?.instagram) && (
                      <SocialIcon
                        href={socialMedia.instagram || data?.socialMedia?.instagram || 'https://zynva.in'}
                        title="Instagram"
                      >
                        <svg
                          className="group-hover:text-white text-gray-400 transition-colors duration-300"
                    ...
                    {(socialMedia.youtube || data?.socialMedia?.youtube) && (
                      <SocialIcon
                        href={socialMedia.youtube || data?.socialMedia?.youtube || 'https://zynva.in'}
                        title="YouTube"
                      >
                        <svg
                          className="group-hover:text-white text-gray-400 transition-colors duration-300"
                    ...
                    {(socialMedia.twitter || data?.socialMedia?.twitter) && (
                      <SocialIcon
                        href={socialMedia.twitter || data?.socialMedia?.twitter || 'https://zynva.in'}
                    ...
                    {(socialMedia.discord || data?.socialMedia?.discord) && (
                      <SocialIcon
                        href={socialMedia.discord || data?.socialMedia?.discord || 'https://zynva.in'}
                        title="Discord"
                      >
                        <svg
                          className="group-hover:text-white text-gray-400 transition-colors duration-300"
