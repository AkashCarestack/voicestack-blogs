            ...
            <div className='py-3 border-gray-800 '>
              <div className='flex flex-col md:flex-row gap-6 items-center justify-between'>
                ...
                <div className="flex flex-col md:flex-row items-center gap-4">
                  <Anchor elementId='footer-logo' href="/" className="flex-shrink-0">
                    {data?.logo?.asset?.url ? (
                      <Image 
                      ...
                      <Image src={VoicestackLogo} alt='VoiceStack' className="h-8 w-auto" />
                    )}
                  </Anchor>
                ...
                {/* App Store Links */}
                {data?.appStoreLinks && (data.appStoreLinks.googlePlay || data.appStoreLinks.appStore) && (
                ...
                {data?.socialMedia && (
                  <div className="flex items-center gap-3">
                    {data.socialMedia.linkedin && (
                      <SocialIcon className='' href={data.socialMedia.linkedin} title="LinkedIn">
                        <svg
                    ...
                    {data.socialMedia.facebook && (
                      <SocialIcon href={data.socialMedia.facebook} title="Facebook">
                        <svg
                          className="group-hover:text-white text-gray-400 transition-colors duration-300"
                          width="24"
                          height="24"
                    ...
                    {data.socialMedia.instagram && (
                      <SocialIcon href={data.socialMedia.instagram} title="Instagram">
                        <svg
                          className="group-hover:text-white text-gray-400 transition-colors duration-300"
                          width="24"
                          height="24"
                    ...
                    {data.socialMedia.youtube && (
                      <SocialIcon href={data.socialMedia.youtube} title="YouTube">
                        <svg
                          className="group-hover:text-white text-gray-400 transition-colors duration-300"
                          width="24"
                          height="24"
                    ...
                    {data.socialMedia.twitter && (
                      <SocialIcon href={data.socialMedia.twitter} title="Twitter">
                        <svg
                          className="group-hover:text-white text-gray-400 transition-colors duration-300"
                          width="24"
                          height="24"
