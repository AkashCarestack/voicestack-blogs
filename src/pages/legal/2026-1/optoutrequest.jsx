    ...
    <div className="w-full flex justify-center py-40 px-8 legal-content">
      <Section className=" w-full md:max-w-5xl flex flex-col">
        <div className="flex flex-col text-center justify-center mb-10">
          ...
          VoiceStack Inc. dba VoiceStack <br/>
            ...
            <div class="legal_page_body">
              <span>
                <p class="legal__text">
                  ...
                  of the sale of their personal information by VoiceStack Inc.
                  (“VoiceStack”).
                </p>
                <p class="legal__text">
                ...
                <p class="legal__text">
                  ...
                  please review our Privacy Policy available at: <a href="https://www.voicestack.com/legal/2026-1/privacy-policy">
                  https://www.voicestack.com/legal/2026-1/privacy-policy
                  </a>
                  .
                </p>
