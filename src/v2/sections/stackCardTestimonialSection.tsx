          ...
          <div>
              ...
              <div className="flex overflow-x-auto whitespace-nowrap scrollbar-hide scrollbar-none border-y border-gray-200">
                {data?.tabs?.map((testimonial, index) => (
                  <button
                    ...
                    className={`flex w-full flex-col items-center  flex-1 group transition-all duration-300 border-r-[2px] last:border-r-0 ${
                      activeTestimonial === index
                        ? 'grayscale-100 border-b-[3px] border-b-gray-950 border-r-gray-50 bg-gray-50 border-r-[2px]'
                        : 'grayscale hover:grayscale-0 border-r-gray-200'
                    }`}
                  >
                    <div className={`relative md:my-6 my-2`}>
                      <div
            ...
            {page === 'case-studies' ? (
              ...
              <div className="flex flex-col lg:flex-row items-center lg:items-stretch">
                <div className="xl:w-1/2 xl:max-w-[666px] w-full hidden md:flex items-center justify-center border-r border-gray-200">
                  <div
