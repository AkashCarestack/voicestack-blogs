...
interface ReviewTestimonialV2Props {
  data: any
  buttonDemo?: boolean
}

export default function ReviewTestimonialV2({ data, buttonDemo = false }: ReviewTestimonialV2Props) {
  ...
  return (
    <>
      ...
      <Section className="relative py-sm md:py-md  bg-white font-geist" border="b">
